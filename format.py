class Format:
    ...
    def buildFormat(self):
        if(self.getTokenLength()>0):
            self.format=""+str(self.header1)+str(self.code)+str(self.messageId)+str(self.token)
        else:
            self.format=""+str(self.header1)+str(self.code)+str(self.messageId)
        return self.format
    ...
    def print(self):
        ...
        print("Formatul-> " + str(self.format))
        print("Format size->" + str(len(self.format)))
